...
class OpcoesPagamento(Form):
    debito = BooleanField('Cartão de Débito')
    credito = BooleanField('Cartão de Crédito')
    pix = BooleanField('Pix')
    dinheiro = BooleanField('Dinheiro')

class OpcoesFrete(Form):
    buscar = BooleanField('Buscar no local (R$ 0,00)')
    entrega = BooleanField('Entrega (Taxa de entrega)')
